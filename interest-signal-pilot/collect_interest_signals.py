...
QUERIES = ["서울 민원", "서울 공사 지연", "서울 안전 사고", "서울 재개발 갈등", "서울 교통 불편", "서울 주거 피해", "서울 복지 공백", "서울 자치구 논란"]
...
def fetch_news(query: str) -> list[dict]:
    ...
    for item in root.findall("./channel/item"):
        ...
        rows.append({"query": query, "title": title, "url": link, "published_at": clean(item.findtext("pubDate")), "summary": summary, "seoul_relevant": relevant, "relevance_reason": reason, "signal_type": "NEWS_ATTENTION", "status": "DISCOVERY_SIGNAL"})
    return rows
