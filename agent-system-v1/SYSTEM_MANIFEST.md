...
14. 서울시 감사 결과 L4 그림자 평가: 매일 10:45 KST 최근·최대 12개월 후향 공식 감사문서 중 미평가 최대 3건만 표본화한다. 사람은 문서 가치와 대표 각도 선택을 분리해 기록한다. 소스 등록 단계는 L3로 유지하고 7개 관측일·12개 고유 문서·사람 판정 완료율 80%와 대표 각도 적중률 기준을 충족하기 전에는 승격 판정을 하지 않는다. 원문 비저장, 브리핑·장부 자동 연결 금지.
