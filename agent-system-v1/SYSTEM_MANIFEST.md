...
| 편집 게이트 | daily-briefing-v4/EDITORIAL_GATE.md |
| 브리핑 형식 | daily-briefing-v4/OUTPUT_TEMPLATE.md |
| 자동 검증 | agent-system-v1/validate_discovery_system.py |

## 예약 흐름

1. 관심 레이더: 매일 08:00, 12:00, 17:30 KST
2. 일일 브리핑: 매일 09:30 KST
...
- 상태 변경은 장부, 편집자 피드백 처리 상태, 각 작업의 산출물에 한정한다.
