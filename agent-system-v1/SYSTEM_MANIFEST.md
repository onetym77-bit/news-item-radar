...
17. 공식 SNS L0 계정 확인: 서울시와 25개 자치구 슬롯을 등록하되 공식 서울시 목록에서 직접 연결된 시 기관 계정 3개만 우선 검증한다. 구청·단체장 개인 계정은 미등록 상태를 유지한다. 수동·PR 읽기 전용으로 공식 목록의 링크만 재확인하고 게시물·질문·브리핑·장부에 연결하지 않는다.
